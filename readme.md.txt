 ...
 * Vue JS 3.0 with NET 5 Web API available here https://marketplace.visualstudio.com/items?itemName=alexandredotnet.vuejsdotnetfive
...
2. Open 
3. Run "dotnet ef database update" in View/OtherWindows/Package Manager Console
